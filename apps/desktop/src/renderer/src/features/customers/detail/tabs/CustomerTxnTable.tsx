      ...
      <div className="flex shrink-0 flex-wrap items-center gap-2.5">
        <div className="relative w-64 min-w-0">
          ...
          <Input
            ...
            className="bg-muted/60 focus-visible:border-ring focus-visible:bg-background h-9 rounded-md border-transparent pl-9 pr-9 text-sm shadow-none transition-colors"
          />
          {searchInput && (
            <button
              type="button"
