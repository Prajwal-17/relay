  ...
  return (
    <div className="bg-background flex h-full min-h-0 items-center justify-center p-3">
      <section className="border-border bg-card w-full max-w-lg rounded-(--radius-panel) border p-6 text-center">
        <span className="bg-hover text-foreground mx-auto flex size-11 items-center justify-center rounded-(--radius-control)">
          <FileBarChart className="size-5" />
        </span>
        <div className="text-foreground mt-4 inline-flex items-center gap-1.5 text-xs font-semibold">
