...
--> statement-breakpoint
INSERT INTO `__new_product_history`("id", "name", "weight", "unit", "product_id", "old_price", "new_price", "old_mrp", "new_mrp", "created_at", "updated_at") SELECT "id", "name", "weight", "unit", "product_id", "old_price", "new_price", "old_mrp", "new_mrp", "created_at", "updated_at" FROM `product_history`;--> statement-breakpoint
